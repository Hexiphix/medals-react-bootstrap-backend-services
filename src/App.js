...
const App = () => {
  const apiEndpoint = "https://medals-jam-countries-api.azurewebsites.net/jwt/api/country"; //const apiEndpoint = "https://localhost:7038/jwt/api/country";
  const hubEndpoint = "https://medals-jam-countries-api.azurewebsites.net/medalsHub"; // const chatHubEndPoint = "https://localhost:7038/medalsHub"; OR const chatHubEndPoint = "https://aws-chat-6.azurewebsites.net/hubs/chat";
  const usersEndpoint = "https://medals-jam-countries-api.azurewebsites.net/api/users/login"; // const usersEndpoint = "https://localhost:7038/api/users/login";
